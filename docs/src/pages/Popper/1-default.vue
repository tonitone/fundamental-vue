...
<template>
  <div class="container">
    <FdButton id="1-target" styling="light">Click to show Popper</FdButton>
    <FdPopper
      target="1-target"
      placement="top"
      arrow-element=".popper-arrow"
      :show-on-create="true"
