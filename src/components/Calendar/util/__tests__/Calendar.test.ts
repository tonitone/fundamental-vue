...
describe('Calendar', () => {
  ...
  it('month', () => {
    ...
    expect(sameDays(week1, asDates([[2018, 0, 28], [2018, 0, 29], [2018, 0, 30], [2018, 0, 31], [2018, 1, 1], [2018, 1, 2], [2018, 1, 3]]))).toBe(true);
    expect(sameDays(week2, asDates([[2018, 1, 4], [2018, 1, 5], [2018, 1, 6], [2018, 1, 7], [2018, 1, 8], [2018, 1, 9], [2018, 1, 10]]))).toBe(true);
    expect(sameDays(week3, asDates([[2018, 1, 11], [2018, 1, 12], [2018, 1, 13], [2018, 1, 14], [2018, 1, 15], [2018, 1, 16], [2018, 1, 17]]))).toBe(true);
    expect(sameDays(week4, asDates([[2018, 1, 18], [2018, 1, 19], [2018, 1, 20], [2018, 1, 21], [2018, 1, 22], [2018, 1, 23], [2018, 1, 24]]))).toBe(true);
    expect(sameDays(week5, asDates([[2018, 1, 25], [2018, 1, 26], [2018, 1, 27], [2018, 1, 28], [2018, 2, 1], [2018, 2, 2], [2018, 2, 3]]))).toBe(true);
  });
});
